...
export default class Autocompleter extends Component {
  ...
  renderPersonSearchFields() {
    const {states, counties, onChange, onCancel, onClear, onBlur, onFocus, personSearchFields, isAdvancedSearchOn, clientIdError, ssnErrors, dobErrors, canSearch} = this.props
